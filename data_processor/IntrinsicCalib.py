...
def detectCheckerboardAndIntrinsicCalib(images, CHECKERBOARD_SHAPE=(10, 7), CHECKERBOARD_GRID_SIZE=20, criteria=(cv2.TERM_CRITERIA_EPS + cv2.TERM_CRITERIA_MAX_ITER, 30, 0.001), savePath=None, imageRange=None, visualize=False, returnUsedFileNames=False):
